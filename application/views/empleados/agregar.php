    ...
    <form class="form-horizontal"  method="post" role="search" action="<?php echo $Controlador;?>">
        ...
        <div id="eseste" style="border-color: #666; border-width: 1px; border-style: solid; width: 50%; -webkit-border-radius:16px;" >
            <div style="margin-top:20px">
                  ...
                  <div class="col-sm-9">
                        <input name="nombre" placeholder="Nombre del empleado ***Campo Obligatorio*** " type="text" class="form-control" value=<?php echo $Nombre; ?>>
                  </div>
                 </div>
                 <div class="form-group">
                  ...
                  <div class="col-sm-9">
                        <input name="usuario" placeholder="Usuario ***Campo Obligatorio*** " type="text" class="form-control" value=<?php echo $Usuario; ?>>
                  </div>
                 </div>
                  <div class="form-group">
                  <label class="col-sm-2 control-label">Contraseña: </label>
                  <div class="col-sm-9">
                      <input name="contrasenia" placeholder="Contraseña ***Campo Obligatorio*** " type="password" class="form-control" value=<?php echo $Contrasenia; ?>>
                  </div>
                 </div>
                <div class="form-group">
